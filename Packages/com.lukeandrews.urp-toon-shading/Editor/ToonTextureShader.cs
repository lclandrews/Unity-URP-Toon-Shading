...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    internal class ToonMasterTex2DShader : BaseShaderGUI
    {
        ...
        public void DrawLightingOptions()
        {
            ...
            materialEditor.TexturePropertySingleLine(ToonMainGUI.Styles.mainGradText, mainRampProp);
            materialEditor.TexturePropertySingleLine(ToonMainGUI.Styles.addGradText, addRampProp);
        }

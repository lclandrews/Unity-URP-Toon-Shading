Shader "Universal Render Pipeline/Toon Simple Ramp"
{
    Properties
    {        
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "ToonSimpleInput.hlsl"
            #include "ToonSimpleVertexPass.hlsl"
            #include "ToonSimpleFragmentPass.hlsl"

            #pragma vertex ToonSimplePassVertex
            #pragma fragment ToonSimplePassFragment            
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.ToonSimpleShader"
}

Shader "Universal Render Pipeline/Toon Three Tone Color Mask"
{
    Properties
    {        
    ...
    SubShader
    {
        ...
        Pass 
        {
            ...
            #include "ThreeTone/ToonThreeToneColorMaskInput.hlsl"
        ...
        Pass
        {
            ...
            #include "ThreeTone/ToonThreeToneColorMaskFragmentPass.hlsl"
    ...
    CustomEditor "ToonShading.Editor.ToonThreeToneColorMaskShaderGUI"
}

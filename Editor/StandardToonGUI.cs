    ...
    public static class StandardToonGUI
    {
            ...
            Action<Material> materialChanged = null)
        {
            ...
            if (backlightEnabled)
            {
                ...
                materialEditor.ShaderProperty(properties.backlight, ToonMasterGUI.Styles.backlightText);
        ...
        public static void DrawOcclusionArea(MaterialEditor editor, MaterialProperty occlusionMap, MaterialProperty occlusionStrength)
        {
            ...
            {
                editor.TexturePropertySingleLine(ToonMasterGUI.Styles.occlusionText, occlusionMap, occlusionMap.textureValue != null ? occlusionStrength : null);
            }
        }
            ...
            Action<Material> materialChanged = null)
        {
            ...
            {
                BaseShaderGUI.TextureColorProps(materialEditor, ToonMasterGUI.Styles.specularMapText, properties.specMap, properties.specColor);

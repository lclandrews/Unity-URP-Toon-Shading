Shader "Universal Render Pipeline/Toon Gradient Ramp"
{
    Properties
    {        
        _MainGradType ("Main Gradient Type", Int) = 0
        _MainGradColors ("Main Gradient Length", Int) = 0

        _AddGradType("Additional Gradient Type", Int) = 0
        _AddGradColors("Additional Gradient Length", Int) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "ToonGradientInput.hlsl"
            #include "Standard/ToonStandardVertexPass.hlsl"
            #include "ToonGradientFragmentPass.hlsl"

            #pragma vertex ToonStandardPassVertex
            #pragma fragment ToonGradientPassFragment            
            ENDHLSL
        }
    ...
    CustomEditor "UnityEditor.Rendering.Universal.ShaderGUI.ToonMasterShader"
}
